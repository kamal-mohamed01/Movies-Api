...
export default function Home() {
    ...
    async function getTrending() 
    {
        ...
        let {data} = await axios.get(`https://api.themoviedb.org/3/trending/all/week?api_key=4b87eb4572773b982d2ee17befe591ed`)
    ...
    <div className="row">
        {loading===true? <h2> Loding... <i className='fas fa-spinner fa-spin'></i></h2>:trendingMovies.map((movie)=> <div key={movie.id} className=' col-md-2'>
            <img className='w-100' src={`https://image.tmdb.org/t/p/w500/`+movie.poster_path} alt="img poster" />
